 ...
 */
"use strict";
var achtu = (function(d) {
    var achtuVersion = "v1.0";
    var document = d;
    ...
    var $achtuj = jQuery.noConflict();

    init();

    // this is what makes some of the method definitions above as public
    // refer: "revealing module pattern"
    return {
        init: init,
